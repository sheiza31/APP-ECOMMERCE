        ...
        <>
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
                ...
                <div className="flex items-center bg-surface-container-lowest border border-outline-variant p-1 rounded-xl shadow-sm">
                    <button className="px-4 py-2 font-label-md text-label-md text-gray-400 hover:bg-black hover:text-white rounded-lg transition-all">Last 7 Days</button>
                    <button className="px-4 py-2 font-label-md text-label-md text-gray-400 hover:bg-black hover:text-white rounded-lg transition-all">Last 30 Days</button>
                    <button className="px-4 py-2 font-label-md text-label-md text-gray-400 hover:bg-black hover:text-white rounded-lg transition-all">Last 90 Days</button>
                    <div className="w-px h-6 bg-outline-variant mx-1"></div>
                    <button className="flex items-center px-4 py-2 font-label-md text-label-md text-gray-400 hover:bg-black hover:text-white rounded-lg transition-all">
