        ...
        <>
            <aside className="flex flex-col h-full py-8 px-4 border-r border-outline-variant h-screen w-64 fixed left-0 top-0 bg-surface-container-lowest dark:bg-primary-container z-50">
                ...
                <nav className="flex-1 space-y-1 overflow-y-auto">
                    <Link className="flex items-center gap-stack-md bg-secondary-container dark:bg-secondary text-on-secondary-container dark:text-on-secondary rounded-lg px-4 py-3 transition-all duration-200 ease-in-out" href="#">
                ...
                <div className="mt-auto pt-6 border-t border-outline-variant px-4 space-y-4">
                    <button className="w-full bg-primary text-white py-3 rounded-lg font-label-md hover:opacity-90 transition-opacity">View Storefront</button>
                    <div className="space-y-1">
                        <Link className="flex items-center gap-stack-md text-secondary text-label-md py-2 hover:text-primary transition-colors" href="#">
                            <span className="material-symbols-outlined"><HelpCircle /></span>
                            Help Center
                        </Link>
